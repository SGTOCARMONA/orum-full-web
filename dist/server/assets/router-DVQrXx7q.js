...
const appCss = "/assets/styles-53CzgcAk.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-deep px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90", children: "Volver al inicio" }) })
  ] }) });
}
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "ORUM — Prevención y Recuperación Deportiva | Cris Carmona" },
      { name: "description", content: "Masaje deportivo, prevención y recuperación para personas que entrenan fuerte. Granada y Motril. Reserva por WhatsApp." },
      { property: "og:title", content: "ORUM — Prevención y Recuperación Deportiva" },
      { property: "og:description", content: "Masaje deportivo y recuperación para atletas. Granada y Motril." },
...
const $$splitComponentImporter = () => import("./index-qX5e6Omw.js");
